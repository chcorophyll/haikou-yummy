...
import { Search, CheckCircle, XCircle, Edit, Trash2, Filter, Loader2, Plus } from 'lucide-react';
      ...
      {loading ? (
        ...
        <div className="glass-panel border border-tesla-gray/30 rounded-2xl overflow-hidden shadow-2xl">
          <table className="w-full text-left text-sm border-collapse">
            <thead>
              <tr className="bg-tesla-gray/20 border-b border-tesla-gray/30 text-tesla-muted text-[10px] uppercase tracking-[0.2em] font-bold">
                ...
                <tr key={rest._id} className="hover:bg-tesla-red/5 transition-colors group">
                  ...
                  <td className="px-6 py-5 text-right">
                    <div className="flex justify-end gap-2">
                      <button 
                        onClick={() => { setEditingRestaurant(rest); setIsEditorOpen(true); }}
